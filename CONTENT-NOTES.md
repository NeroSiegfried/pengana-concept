# Content status and launch checks

The supplied `pengana-relume-brief.md` is the only consolidated local content
source. It is a design prompt pack, so even its facts should be reviewed by the
business before launch.

## Published baseline

- Pengana Concept Limited: family-owned Nigerian holding company; Abuja head
  office.
...
- fabricated property counts, apartment counts, workforce figures, hectares,
  harvest tonnage, partner counts and states supplied;
- invented founding timelines and project completion dates;
- named properties, stays, amenities and availability claims;
- testimonials and guest reviews;
- seeded newsroom and press articles;
- social links pointing to `#`;
- unsupported email addresses, response-time promises and newsletter signups;
- front-end forms that appeared to submit but had no endpoint;
- fake policy and terms links;
- unrelated stock portraits and repeated office photography;
- portfolio, gallery and careers sections without authentic material.

## Confirm before public launch

1. Exact legal styling of every company name.
2. Office addresses and all three shared telephone lines.
3. Public spelling and titles for:
   - Bitrus B. Nabasu, mni;
   - Mrs. Victoria Nabasu;
   - Jerry A. Nabasu;
   - Jeffersen S. Nabasu;
   - Jibrin Victor Nabasu;
   - Bitrus Bako Nabasu;
